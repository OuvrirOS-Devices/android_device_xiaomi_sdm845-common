...
#define LOG_TAG "ouvrir.livedisplay@2.0-service.xiaomi_sdm845"
...
using ::vendor::ouvrir::livedisplay::V2_0::ISunlightEnhancement;
using ::vendor::ouvrir::livedisplay::V2_0::implementation::SunlightEnhancement;
